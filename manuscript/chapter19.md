...
[^19-344]: Are you saying we shouldn't use "yesterday's weather", we shouldn't use the points from the last sprint to figure out what we can do this sprint? That's exactly what I'm saying. You're not a robot, you are paid to use your brain. Now you know how to keep the backlog simple, right? And the reason we keep it simple is so we can think about it, the entire thing, at one time, right? So. Think about it. Figure out what you can do next sprint. Everything in your project should be changing. The difficulty to deliver should be going down, your understanding of the nature should get a lot better, your teamwork should be getting better. So how in heck could you use points that way? The teams I see using points that way are teams in which _nothing_ is changing. Don't be that team. I will come and beat you with a wet noodle. Using points from the previous sprint to drive what goes in the next sprint -- also called "Yesterday's Weather" -- is a hack. It's a hack teams have to use because they don't know how to manage their information stream.
