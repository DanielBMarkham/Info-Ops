...
[^2-6a]: I am deliberately skipping over the thesis and antithesis part of the dialectic early in this book. Later on when we get to Hypothesis-Driven Backlogs I'll come back and explain why, then cover how they fit into everything else.
...
You learned why teams build the wrong thing. You learned how we're going to fix that, beginning with learning some strategies for figuring out which questions to ask and asking them the right way.
