...
Master Models are the top of the pyramid. They're the most fuzzy and vague pieces of information we can tag while still being something useful. They're how the information we gather joins up the rest of the universe with whatever it is we're doing. 
