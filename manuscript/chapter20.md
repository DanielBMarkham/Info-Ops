...
You learned why Meta is the thing you should most focus on once you understand Structured Analysis. You learned how to use EasyAM to take notes in detail while you're talking using notepad or another text editor. You learned why ranking the backlog isn't as important as selectively decomposing it. You learned how to "automatically" order the backlog using Analysis Affinity Mapping.
